...
public class EnemyBaseCI : Editor 
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (mSelf.isBoss)
        {
            EditorGUILayout.PropertyField(serializedObject.FindProperty("hpBarVisibleDistance"));
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("attackDelayList"), true);
