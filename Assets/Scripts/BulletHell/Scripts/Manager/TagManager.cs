...
public class TagManager : MonoBehaviour 
{
    ...
    public string ENV_OBJ_TrapLaser = "TrapLaser";
    ...
    public string UI_DisappearingBulletName = "DisappearingBullet";
	public string UI_MagicCircleName = "MagicCircle";
    ...
    public string sortLayerTopG2 = "TopGround2";
    public string sortLayerMidGTop2 = "MidGroundTop2";
