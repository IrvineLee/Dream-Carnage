...
public class BombController : MonoBehaviour 
{
    ...
    public void ActivateBomb()
    {
        ...
        if (type == Type.TIME_STOP)
        {
            ...
            if (AudioManager.sSingleton != null)
            {
                ...
                AudioManager.sSingleton.PlayClockTickSfx();
            }
        }
        else if(type == Type.BULLET_WIPE)
		{
            ...
            if (AudioManager.sSingleton != null) AudioManager.sSingleton.PlayBulletClearSfx();
		}
		else if(type == Type.SHIELD_AREA)
		{
            ...
            if (AudioManager.sSingleton != null) AudioManager.sSingleton.PlayShieldAreaFireSfx();
    ...
    IEnumerator TimeStopSequence (float stopDur, float returnSpdDur)
    {
        ...
        if(AudioManager.sSingleton != null) AudioManager.sSingleton.StopClockTickSfx();
